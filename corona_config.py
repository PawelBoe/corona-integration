...
file_country_data = "country_data.csv"
...
path_country_data = "{}/{}".format(data_folder, file_country_data)
...
backup_path_country_data = "{}/backup_{}".format(data_folder, file_country_data)
...
data_sources = [
    ...
    #(link_country_data, path_country_data, backup_path_country_data),
]
