...
**Note**: The death toll underlies dayly (and yearly) fluctuations. Statistically significant conclusions regarding overlap of deaths due to COVID-19 and deaths that would have occured anyway cannot be drawn based on this graph.
...
![Corona-positives-vs-tests-germany](results/tests_positives_germany.png)
