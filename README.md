...
The source code can be found in the function `corona_cases_germany` in `corona_analysis.py`. This curve is smoothed by averaging each day with 2 days before (sliding window smoothing with a window size of 3 and a stride of 1).
